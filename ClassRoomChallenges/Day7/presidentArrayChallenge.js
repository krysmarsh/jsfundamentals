const presidents = [
   ...
   //Bronze: Build a for loop that will loop through the array and console log
   //the first and last name of every president
    ...
    //for(let i = 0; i < 45; i++) {
       // console.log(presidents.first[0]);
        //console.log(i);
        //console.log(presidents.first); (presidents.last);
   // }
...
//   }
   ...
   //only console log if the president is alive
...
for(let i = 0; i < presidents.length; i ++) {
   ...
   //convert statement to a ternary